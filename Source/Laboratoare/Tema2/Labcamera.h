...
namespace Tema
{
	...
	public:
		...
		void RotateFirstPerson_OX(float angle)
		{
			...
			// Use glm::rotate()
			glm::vec4 newVec = glm::rotate(glm::mat4(1.0f), angle, right) * glm::vec4(forward, 0);
		...
		void RotateFirstPerson_OY(float angle)
		{
			...
			// Use glm::rotate()
			glm::vec4 newVec = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 1, 0)) * glm::vec4(forward, 0);
			forward = glm::normalize(glm::vec3(newVec));
			newVec = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 1, 0)) * glm::vec4(right, 0);
		...
		void RotateFirstPerson_OZ(float angle)
		{
			...
			// Don't forget to normalize the vectors
			glm::vec4 newVec = glm::rotate(glm::mat4(1.0f), angle, forward) * glm::vec4(right, 0);
			right = glm::normalize(glm::vec3(newVec));
